...
const SyndicatorExternalLenderFeeSchema = new mongoose.Schema({
    percent: {
        type: String,
        default: null
    },
    ...
    type: {
        type: String,
        default: null,
        enum: ['Pass-Thru', 'Additional %', 'Funded', 'Tiered by Funded', 'Payback', 'Tiered by Factor Rate', 'Amount', null]
    }
}, { _id: false });

module.exports = SyndicatorExternalLenderFeeSchema; 