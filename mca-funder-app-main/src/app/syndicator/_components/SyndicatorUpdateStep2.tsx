...
interface SyndicatorUpdateStep2Props {
...
export default function SyndicatorUpdateStep2({
  values,
  setFieldValue,
  onNext,
  onBack,
  loading
}: SyndicatorUpdateStep2Props) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 mt-1">
              Sensitive data is masked. Enter new value to update.
            </div>
