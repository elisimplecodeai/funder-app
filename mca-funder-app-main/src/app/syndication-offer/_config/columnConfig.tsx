...
import { formatCurrency, formatTime, formatNumberFourDecimals, formatFunder, formatSyndicator, formatExpireDate } from '@/lib/utils/format';
...
export const columns: ColumnConfig<SyndicationOffer>[] = [
  ...
  },
  {
    ...
    visible: true,
    render: (value) => {
      const str = formatExpireDate(value as string);
      if (str === '-' || !str) return '-';
      const [date, days] = str.split('\n');
      return (
